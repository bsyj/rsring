...
/**
 * 500级经验储罐 - 具有更大容量的经验存储设备
 */
@Optional.Interface(iface = "baubles.api.IBauble", modid = "baubles")
public class ItemExperienceTank500 extends ItemExperiencePump implements IBauble {

    // 500级所需经验：1,045,970 XP
    private static final int DEFAULT_CAPACITY = 1045970;

    public ItemExperienceTank500() {
        super("experience_tank_500", "rsring.experience_tank_500");
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, net.minecraft.nbt.NBTTagCompound nbt) {
        ...
        if (data == null) {
            ...
            data.setInteger("fixedMaxXp", DEFAULT_CAPACITY); // 500级储罐固定容量
