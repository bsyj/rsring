...
public class ItemExperienceTank100 extends ItemExperiencePump implements IBauble {

    public ItemExperienceTank100() {
        super();
        setTranslationKey("rsring.experience_tank_100"); // 100级经验储罐
        setRegistryName(new ResourceLocation("rsring", "experience_tank_100")); // 100级经验储罐
        setMaxStackSize(1);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if (data == null) {
            // 即使没有NBT数据也要显示基础信息
            int initialCapacity = 873320; // 100级玩家经验对应的容量
            tooltip.add(TextFormatting.GRAY + "等级: " + TextFormatting.AQUA + "100级");
        ...
        int capacityLevels = data.hasKey("capacityLevels") ? data.getInteger("capacityLevels") : 11;  // 默认11级
        int max = 873320; // 100级玩家经验对应的容量
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!world.isRemote) {
            ...
            int maxXp = 873320; // 100级玩家经验对应的容量
            
            // 构造消息：100级储罐 - Y / Z mb
            String message = TextFormatting.AQUA + "100级储罐 " + 
                           TextFormatting.GRAY + "- " +
