...
/**
 * 100级经验储罐 - 具有更大容量的经验存储设备
 */
@Optional.Interface(iface = "baubles.api.IBauble", modid = "baubles")
public class ItemExperienceTank100 extends ItemExperiencePump implements IBauble {

    // 100级所需经验：30970 XP
    private static final int DEFAULT_CAPACITY = 30970;

    public ItemExperienceTank100() {
        super("experience_tank_100", "rsring.experience_tank_100");
    }
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if (data == null) {
            // 即使没有NBT数据也要显示基础信息
            tooltip.add(TextFormatting.GRAY + "玩家等级: " + TextFormatting.AQUA + "100级");
