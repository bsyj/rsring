...
import com.rsring.proxy.CommonProxy;
...
public class RsRingMod
{
    ...
    @SidedProxy(serverSide = "com.rsring.proxy.CommonProxy", clientSide = "com.rsring.proxy.ClientProxy")
    public static CommonProxy proxy;

    public static ItemAbsorbRing absorbRing;
    public static ItemExperiencePump experiencePump;
    public static com.rsring.item.ItemExperiencePumpController experiencePumpController;
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        network.registerMessage(com.rsring.network.PacketToggleRsRing.Handler.class, com.rsring.network.PacketToggleRsRing.class, 3, Side.SERVER);
        // Register packet for syncing ring filter from client -> server
        network.registerMessage(com.rsring.network.PacketSyncRingFilter.Handler.class, com.rsring.network.PacketSyncRingFilter.class, 4, Side.SERVER);
