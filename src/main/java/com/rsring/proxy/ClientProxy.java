...
import com.rsring.client.ContainerRingFilter;
import com.rsring.client.GuiRingFilterContainer;
...
public class ClientProxy extends CommonProxy {
    ...
    public void handleToggleRsRing(EntityPlayerMP player) {
        ...
        player.getServerWorld().addScheduledTask(() -> {
            ...
            com.rsring.util.ItemLocationTracker tracker = 
                com.rsring.util.ItemLocationTracker.findItem(player, ItemAbsorbRing.class);
     ...
     * 获取位置的显示名称
     */
    private String getLocationDisplayName(com.rsring.util.ItemLocationTracker.LocationType locationType) {
        switch (locationType) {
