...
public class ItemExperienceTank1000 extends ItemExperiencePump implements IBauble {
    ...
    public ItemExperienceTank1000() {
        super();
        setTranslationKey("rsring.experience_tank_1000"); // 1000级经验储罐
        setRegistryName(new ResourceLocation("rsring", "experience_tank_1000")); // 1000级经验储罐
        setMaxStackSize(1);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if (data == null) {
            // 即使没有NBT数据也要显示基础信息
            int initialCapacity = 1418780120; // 1000级玩家经验对应的容量
            tooltip.add(TextFormatting.GRAY + "等级: " + TextFormatting.AQUA + "1000级");
        ...
        int capacityLevels = data.hasKey("capacityLevels") ? data.getInteger("capacityLevels") : 22;  // 默认22级
        int max = 1418780120; // 1000级玩家经验对应的容量
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!world.isRemote) {
            ...
            int maxXp = 1418780120; // 1000级玩家经验对应的容量
    ...
    public static int getMaxXp() {
        return 1418780120; // 1000级玩家经验对应的容量
    }
}
