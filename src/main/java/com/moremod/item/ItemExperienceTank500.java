...
public class ItemExperienceTank500 extends ItemExperiencePump implements IBauble {

    public ItemExperienceTank500() {
        super();
        setTranslationKey("rsring.experience_tank_500"); // 500级经验储罐
        setRegistryName(new ResourceLocation("rsring", "experience_tank_500")); // 500级经验储罐
        setMaxStackSize(1);
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        if (data == null) {
            // 即使没有NBT数据也要显示基础信息
            int initialCapacity = 167754120; // 500级玩家经验对应的容量
            tooltip.add(TextFormatting.GRAY + "等级: " + TextFormatting.AQUA + "500级");
        ...
        int capacityLevels = data.hasKey("capacityLevels") ? data.getInteger("capacityLevels") : 19;  // 默认19级
        int max = 167754120; // 500级玩家经验对应的容量
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!world.isRemote) {
            ...
            int maxXp = 167754120; // 500级玩家经验对应的容量
            
            // 构造消息：500级储罐 - Y / Z mb
            String message = TextFormatting.AQUA + "500级储罐 " + 
                           TextFormatting.GRAY + "- " +
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, net.minecraft.nbt.NBTTagCompound nbt) {
        ...
        if (data == null) {
            ...
            data.setInteger("capacityLevels", 19); // 对应原系统的19级
    ...
    public static int getMaxXp() {
        return 167754120; // 500级玩家经验对应的容量
    }
}
