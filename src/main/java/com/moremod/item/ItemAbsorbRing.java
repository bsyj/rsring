...
public class ItemAbsorbRing extends Item implements IBauble {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        // 只有手持戒指右键空气才打开GUI
        if (world.isRemote) {
            com.moremod.rsring.RsRingMod.proxy.openAbsorbRingGui(stack);
        } else {
    ...
    public static boolean tryOpenAbsorbRingGui(EntityPlayer player) {
        ...
        if (player.world.isRemote) {
            // 使用proxy打开黑白名单GUI
            com.moremod.rsring.RsRingMod.proxy.openAbsorbRingGui(absorbRing);

            // Provide feedback about successful access
            com.moremod.experience.RingDetectionResult.InventoryLocation location = findRingLocation(result, absorbRing);
     ...
     */
    private static ItemStack findAbsorbRingInResults(com.moremod.experience.RingDetectionResult result) {
